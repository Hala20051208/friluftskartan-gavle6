...
require([
  ...
  "esri/widgets/Sketch",
    ...
    const kategorier = {
      motionsspar: {
        fil: "motionsspar_length_fixed.json",
        typ: "line",
        renderer: {
          type: "unique-value",
          field: "NAMN",
      ...
      pulkabackar: { fil: "pulkabackar.json", färg: "orange", typ: "marker" },
      aktivitetsytor: { fil: "aktivitetsytor.json", färg: "purple", typ: "marker" },
      badplatser: { fil: "badplatser.json", färg: "blue", typ: "marker" },
      parkmobler: { fil: "parkmobler.json", färg: "brown", typ: "marker" },
      papperskorgar: { fil: "papperskorgar.json", färg: "gray", typ: "marker" },
      idrottsanlaggningar: { fil: "idrott_motion.json", färg: "red", typ: "marker" },
      utegym: { fil: "utegym.json", färg: "teal", typ: "marker" },
      lekplatser: { fil: "lekplatser.json", färg: "magenta", typ: "marker" },
      toaletter: { fil: "offentliga_toaletter.json", färg: "black", typ: "marker" },
      livraddning: { fil: "livraddningsutrustning.json", färg: "yellow", typ: "marker" },
    };
